...
class QuotaSetsController(wsgi.Controller):
    ...
    @validation.schema(quota_sets.update, min_version="2.1",
                       max_version=MAX_PROXY_API_SUPPORT_VERSION)
    ...
    @validation.schema(quota_sets.update_v236,
                       min_version=MIN_WITHOUT_PROXY_API_SUPPORT_VERSION)
    def update(self, req, id, body):
        ...
        for key, value in six.iteritems(body['quota_set']):
            ...
            if parent_project_id:
                ...
                allocated_quotas[key] = (
                    parent_project_quotas[key].get('child_hard_limits', 0)
                    + value)
